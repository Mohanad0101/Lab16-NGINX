...
## **Этап 3: Настройка межсетевого экрана UFW**
...
## **Этап 4: Изучение конфигурации Nginx**
...
## **Этап 5: Генерация TLS-сертификата**
...
## **Этап 6: Настройка виртуального хоста с HTTPS**
...
*`# Этап 6: Настройка виртуального хоста`*  
`sudo nano /etc/nginx/sites-available/default`  
...
| Сертификат не найден | `ls /etc/nginx/ssl/` | Повторить этап 5 |
